...
const SignIn = () => {
  ...
  return (
    <>
      <div className="page-header" style={{ backgroundImage: "url(" + require("assets/img/federico-beccari.jpg").default + ")" }}>
            ...
            <Col className="ml-auto mr-auto" lg="4">
              <Card className="card-register ml-auto mr-auto">
                ...
                <Form className="register-form">
                  ...
                  <Button block className="btn-round" color="danger">Sign In</Button>
                </Form>
